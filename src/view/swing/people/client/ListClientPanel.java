...
public class ListClientPanel extends JPanel {
    public ListClientPanel(PersonController personController, ProductController productController, Person employee) {
        setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));

        JLabel titleLabel = new JLabel("Listar Clientes");
